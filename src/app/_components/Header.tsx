...
export default function Header() {
  return (
    <div className="bg-gradient-to-bl from-blue-600 to-secondary-700 ">
      <div className="container mx-auto sticky top-0 z-50 px-10 text-card max-sm:px-4  max-lg:px-8 py-4 flex justify-between  items-center">
